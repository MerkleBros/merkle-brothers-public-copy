...
App = {
  ...
  initWeb3: function() {
    ...
    var accounts = App.web3.eth.accounts[0];
    $('#user-address').html(accounts);
  ...
  initContract: function() {
    ...
    //Contract address for ganache-cli
    // App.contractInstance = MerkleBros.at('0xd2e8d9173584d4daa5c8354a79ef75cec2dfa228');

  	// App.contracts.MerkleBros = TruffleContract(merkleBrosArtifact);

  	// // Set the provider for our contract
  	// App.contracts.MerkleBros.setProvider(App.web3Provider);
